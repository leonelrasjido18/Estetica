    ...
    return (
        <div style={{ display: 'flex', minHeight: '100vh', backgroundColor: 'var(--bg-primary)' }}>
            ...
            {showToast && (
                ...
                >
                    <div style={{ backgroundColor: 'rgba(201, 169, 110, 0.1)', padding: '10px', borderRadius: '50%' }}>
            ...
            <aside className={`dashboard-sidebar ${isMobileMenuOpen ? 'mobile-open' : ''}`} style={{ position: 'fixed', top: 0, left: 0, height: '100vh', width: '250px', backgroundColor: 'var(--bg-secondary)', padding: '30px 20px', display: 'flex', flexDirection: 'column', borderRight: '1px solid rgba(255,255,255,0.05)', zIndex: 10, overflowY: 'auto' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '40px' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                        <div style={{ width: '36px', height: '36px', borderRadius: '50%', border: '1.5px solid var(--accent-primary)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--accent-primary)', fontFamily: "'Cormorant Garamond', serif", fontSize: '0.95rem', fontWeight: '600', letterSpacing: '1px', flexShrink: 0 }}>JV</div>
                        <span style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: '1.1rem', fontWeight: '500', color: 'var(--accent-primary)', letterSpacing: '1px' }}>JV Estético</span>
                    </div>
                    <button
                ...
                <nav style={{ display: 'flex', flexDirection: 'column', gap: '2px', flex: 1 }}>
                    ...
                    {[
                        ...
                        <button key={t.id} onClick={() => { setActiveTab(t.id); setIsMobileMenuOpen(false); t.action(); }}
                            style={{
                                display: 'flex', alignItems: 'center', gap: '10px', padding: '10px 15px', borderRadius: '8px',
                                backgroundColor: activeTab === t.id ? 'rgba(201, 169, 110, 0.1)' : 'transparent',
                    ...
                    <button onClick={() => { setActiveTab('config'); setIsMobileMenuOpen(false); }}
                        style={{
                            display: 'flex', alignItems: 'center', gap: '10px', padding: '10px 15px', borderRadius: '8px',
                            backgroundColor: activeTab === 'config' ? 'rgba(201, 169, 110, 0.1)' : 'transparent',
                                    ...
                                    <div style={{ textAlign: 'right' }}>
                                        ...
                                        <div style={{ display: 'flex', gap: '10px', alignItems: 'center', justifyContent: 'flex-end' }}>
                                            <span style={{
                                                ...
                                                backgroundColor: app.status === 'completed' ? 'rgba(0, 204, 102, 0.1)' : app.status === 'pending_payment' ? 'rgba(245, 158, 11, 0.1)' : app.status === 'cancelled' ? 'rgba(239, 68, 68, 0.1)' : 'rgba(201, 169, 110, 0.1)',
                                            ...
                                            {app.clientPhone && (
                                                <button
                                                    ...
                                                    style={{ padding: '6px 10px', borderRadius: '20px', backgroundColor: 'rgba(201, 169, 110, 0.1)', border: 'none', color: 'var(--accent-primary)', cursor: 'pointer', fontSize: '0.75rem', fontWeight: '600' }}
                    ...
                    <div className="animate-fade-in">
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '20px' }}>
                            <div className="card glass-panel" style={{ textAlign: 'center' }}>
                                <div style={{ width: '50px', height: '50px', borderRadius: '50%', backgroundColor: 'rgba(201, 169, 110, 0.1)', margin: '0 auto 15px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    ...
                    <div className="animate-fade-in">
                        ...
                        {showInstallBtn && (
                            <div className="card glass-panel animate-fade-in" style={{
                                marginBottom: '30px',
                                padding: '20px',
                                background: 'linear-gradient(135deg, rgba(201, 169, 110, 0.2) 0%, rgba(10, 10, 10, 0.5) 100%)',
                                ...
                                return (
                                    <div key={d.date} className="card" style={{ padding: '15px', borderTop: isToday ? '3px solid var(--accent-primary)' : '3px solid transparent', minHeight: '150px' }}>
                                        ...
                                        {dayAppts.length === 0 ? (
                                            ...
                                            <div key={a.id} style={{ padding: '6px 8px', backgroundColor: a.status === 'completed' ? 'rgba(0,204,102,0.1)' : a.status === 'cancelled' ? 'rgba(239,68,68,0.08)' : 'rgba(201,169,110,0.1)', borderRadius: '6px', marginBottom: '6px', fontSize: '0.8rem', opacity: a.status === 'cancelled' ? 0.7 : 1 }}>
                        ...
                        <div style={{ display: 'grid', gap: '10px' }}>
                            ...
                            {clients.map(c => (
                                <div key={c.id} className="card" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                    <div style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
                                        <div style={{ width: '45px', height: '45px', borderRadius: '50%', background: 'linear-gradient(135deg, var(--accent-primary), rgba(201,169,110,0.5))', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 'bold', fontSize: '1.1rem' }}>
                        ...
                        <div style={{ display: 'grid', gap: '10px' }}>
                            ...
                            {promotions.map(p => (
                                <div key={p.id} className="card" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', opacity: p.active ? 1 : 0.5 }}>
                                    <div style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
                                        <div style={{ padding: '10px 15px', backgroundColor: 'rgba(201,169,110,0.1)', borderRadius: '10px', fontWeight: 'bold', fontSize: '1.1rem', color: 'var(--accent-primary)', letterSpacing: '1px' }}>
                                            {p.code}
                                        </div>
                                        <div>
